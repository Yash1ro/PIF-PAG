...
namespace hnswlib {
    ...
    public:
        virtual void addPoint(const void *datapoint, labeltype label, float* norm, std::vector<Node>&)=0;
		virtual void setEfc(int) = 0;
        
        
		virtual void compression(int, std::vector<Node>&)=0;	
        ...
        virtual void buildTable(std::vector<Node>&, float**)=0;
